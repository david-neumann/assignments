...
function voterResults(arr) {
   return arr.reduce((final, voter) => {
        if (voter.age >= 18 && voter.age < 26) {
            ...
            final.numMidPeople++; 
        } else if (voter.age >= 36 && voter.age < 56) {
            final.numOldPeople++; 
        }
        if (voter.age >= 18 && voter.age < 26 && voter.voted) {
            final.numYoungVotes++; 
        } else if (voter.age >= 26 && voter.age < 36 && voter.voted) {
            final.numMidVotes++; 
        } else if (voter.age >= 36 && voter.age < 56 && voter.voted) {
            final.numOldVotes++; 
        }
        return final; 
